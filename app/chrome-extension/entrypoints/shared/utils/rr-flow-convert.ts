 ...
 *
 * Design notes:
 * - Builder store still uses V2 types (type, version, steps)
 * - RPC layer uses V3 types (kind, schemaVersion, entryNodeId)
 * - This module provides UI-layer type conversion, wrapping the underlying converters
 */
...
/**
 * Convert V2 Flow to V3 format for RPC save
 * @param flowV2 V2 Flow from the Builder store
 * @returns V3 Flow and warnings
...
/**
 * Check whether value is a V3 Flow
...
/**
 * Check whether value is a V2 Flow
 * @description Used to determine JSON format during import
 */
