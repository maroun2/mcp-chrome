<template>
  ...
  <div v-else class="form-section">
    ...
    <div class="help">This node has no NodeSpec; falling back to the default property panel.</div>
  </div>
  <!-- General fields (timeoutMs/screenshotOnFail etc.) are rendered by the outer PropertyPanel -->
</template>
