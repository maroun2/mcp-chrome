<template>
  ...
  <aside class="property-panel">
    <div v-if="node" class="panel-content">
      ...
      <!-- Property form: rendered by NodeSpec-driven form engine -->
      <PropertyFromSpec
        v-if="node"
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input
            ...
            min="0"
            placeholder="Uses global timeout by default"
          />
        </div>
...
const extractErrors = computed(() => {
  ...
  if (!n.config?.selector && !n.config?.js) errs.push('A selector or js expression is required');
  return errs;
});
